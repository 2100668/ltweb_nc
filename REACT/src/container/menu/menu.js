    ...
    <div className={`container-fluid bg-dark ${styles['menu-container']}`}>
      <nav className="menu-navbar-container navbar-container navbar navbar-expand">
        <ul className={`navbar-nav ${styles['menu-nav']}`}>
          ...
          <li className={`nav-item ${styles['menu-item']}`}>
            <Link className={`nav-link ${styles['menu-link']} active`} to="/news/newsList?page_number=1">
              <i className="fas fa-newspaper"></i> Tin tức
            </Link>
          </li>
          <li className={`nav-item ${styles['menu-item']}`}>
            <Link className={`nav-link ${styles['menu-link']} active`} to="/promotion/promotionList?page_number=1">
